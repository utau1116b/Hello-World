...
namespace MinorShift.Emuera.GameData.Variable
{
	...
	internal sealed partial class VariableData : IDisposable
	{
		...
		/// <summary>
		/// ユーザー変数のうちStaticかつ非Globalなもの。ERHでのDIM(非GLOBAL) と関数でのDIM (STATIC)の両方。ロードやリセットで初期化が必要。
		/// </summary>
		...
		public bool LoadVariableBinary(EraBinaryDataReader reader)
		{
			...
			if (vToken != null && (vToken.IsCharacterData || vToken.Readonly || vToken.IsPrivate || vToken.IsLocal || vToken.IsCalc))
				vToken = null;
