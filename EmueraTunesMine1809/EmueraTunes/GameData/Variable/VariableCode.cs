...
namespace MinorShift.Emuera.GameData.Variable
{
	...
	internal enum VariableCode
	{
		...
		ABLNAME = 0x00 | __STRING__ | __ARRAY_1D__ | __CALC__ | __UNCHANGEABLE__ | __CONSTANT__,//能力。ABL.CSV//csvから読まれるデータは保存されない。変更不可
		EXPNAME = 0x01 | __STRING__ | __ARRAY_1D__ | __CALC__ | __UNCHANGEABLE__ | __CONSTANT__,//経験。EXP.CSV
		TALENTNAME = 0x02 | __STRING__ | __ARRAY_1D__ | __CALC__ | __UNCHANGEABLE__ | __CONSTANT__,//素質。TALENT.CSV
		PALAMNAME = 0x03 | __STRING__ | __ARRAY_1D__ | __CALC__ | __UNCHANGEABLE__ | __CONSTANT__,//能力。PALAM.CSV
		TRAINNAME = 0x04 | __STRING__ | __ARRAY_1D__ | __CALC__ | __UNCHANGEABLE__ | __EXTENDED__ | __CONSTANT__,//調教名。TRAIN.CSV
		MARKNAME = 0x05 | __STRING__ | __ARRAY_1D__ | __CALC__ | __UNCHANGEABLE__ | __CONSTANT__,//刻印。MARK.CSV
		ITEMNAME = 0x06 | __STRING__ | __ARRAY_1D__ | __CALC__ | __UNCHANGEABLE__ | __CONSTANT__,//アイテム。ITEM.CSV
		BASENAME = 0x07 | __STRING__ | __ARRAY_1D__ | __CALC__ | __UNCHANGEABLE__ | __EXTENDED__ | __CONSTANT__,//基礎能力名。BASE.CSV
		SOURCENAME = 0x08 | __STRING__ | __ARRAY_1D__ | __CALC__ | __UNCHANGEABLE__ | __EXTENDED__ | __CONSTANT__,//調教ソース名。SOURCE.CSV
		EXNAME = 0x09 | __STRING__ | __ARRAY_1D__ | __CALC__ | __UNCHANGEABLE__ | __EXTENDED__ | __CONSTANT__,//絶頂名。EX.CSV
		__DUMMY_STR__ = 0x0A | __STRING__ | __ARRAY_1D__ | __CALC__ | __UNCHANGEABLE__ | __EXTENDED__ | __CONSTANT__,
		EQUIPNAME = 0x0B | __STRING__ | __ARRAY_1D__ | __CALC__ | __UNCHANGEABLE__ | __EXTENDED__ | __CONSTANT__,//装着物名。EQUIP.CSV
		TEQUIPNAME = 0x0C | __STRING__ | __ARRAY_1D__ | __CALC__ | __UNCHANGEABLE__ | __EXTENDED__ | __CONSTANT__,//調教時装着物名。TEQUIP.CSV
		FLAGNAME = 0x0D | __STRING__ | __ARRAY_1D__ | __CALC__ | __UNCHANGEABLE__ | __EXTENDED__ | __CONSTANT__,//フラグ名。FLAG.CSV
		TFLAGNAME = 0x0E | __STRING__ | __ARRAY_1D__ | __CALC__ | __UNCHANGEABLE__ | __EXTENDED__ | __CONSTANT__,//一時フラグ名。TFLAG.CSV
		CFLAGNAME = 0x0F | __STRING__ | __ARRAY_1D__ | __CALC__ | __UNCHANGEABLE__ | __EXTENDED__ | __CONSTANT__,//キャラクタフラグ名。CFLAG.CSV
		TCVARNAME = 0x10 | __STRING__ | __ARRAY_1D__ | __CALC__ | __UNCHANGEABLE__ | __EXTENDED__ | __CONSTANT__,
		CSTRNAME = 0x11 | __STRING__ | __ARRAY_1D__ | __CALC__ | __UNCHANGEABLE__ | __EXTENDED__ | __CONSTANT__,
		STAINNAME = 0x12 | __STRING__ | __ARRAY_1D__ | __CALC__ | __UNCHANGEABLE__ | __EXTENDED__ | __CONSTANT__,

		CDFLAGNAME1 = 0x13 | __STRING__ | __ARRAY_1D__ | __CALC__ | __UNCHANGEABLE__ | __EXTENDED__ | __CONSTANT__,
		CDFLAGNAME2 = 0x14 | __STRING__ | __ARRAY_1D__ | __CALC__ | __UNCHANGEABLE__ | __EXTENDED__ | __CONSTANT__,
		STRNAME = 0x15 | __STRING__ | __ARRAY_1D__ | __CALC__ | __UNCHANGEABLE__ | __EXTENDED__ | __CONSTANT__,
		TSTRNAME = 0x16 | __STRING__ | __ARRAY_1D__ | __CALC__ | __UNCHANGEABLE__ | __EXTENDED__ | __CONSTANT__,
		SAVESTRNAME = 0x17 | __STRING__ | __ARRAY_1D__ | __CALC__ | __UNCHANGEABLE__ | __EXTENDED__ | __CONSTANT__,
